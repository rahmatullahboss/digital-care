        ...
        <div className="grid items-center gap-16 lg:grid-cols-2">
          ...
          <div className="max-w-xl mx-auto space-y-6 text-center lg:mx-0 lg:text-left">
            ...
            <h1 className="font-bold leading-tight text-slate-900">
              ...
              <span
                className={`industry-text inline-block rounded-full bg-white/70 px-3 py-1 text-2xl sm:text-3xl md:text-4xl text-teal-600 shadow-inner shadow-white/60 ${isFlipping ? "flip" : ""
                  }`}
              >
